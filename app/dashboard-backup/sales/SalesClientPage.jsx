  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => router.push('/dashboard-backup/sales/new')}>Create New Sale</Button>
      </div>
          ...
          <tbody>
            {filteredSales.map(sale => (
              <tr key={sale.id}>
                ...
                <td className="py-2 px-4 border-b">
                  <Button size="sm" onClick={() => router.push(`/dashboard-backup/sales/${sale.id}`)}>View</Button>
                  <Button size="sm" className="ml-2" onClick={() => router.push(`/dashboard-backup/sales/${sale.id}/edit`)}>Edit</Button>
                </td>
              </tr>
            ))}
          </tbody>
