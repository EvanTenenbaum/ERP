  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => router.push('/dashboard-backup/customers/new')}>Add New Customer</Button>
      </div>
          ...
          <tbody>
            {filteredCustomers.map(customer => (
              <tr key={customer.id}>
                ...
                <td className="py-2 px-4 border-b">
                  <Button size="sm" onClick={() => router.push(`/dashboard-backup/customers/${customer.id}`)}>View</Button>
                  <Button size="sm" className="ml-2" onClick={() => router.push(`/dashboard-backup/customers/${customer.id}/edit`)}>Edit</Button>
                </td>
              </tr>
            ))}
          </tbody>
