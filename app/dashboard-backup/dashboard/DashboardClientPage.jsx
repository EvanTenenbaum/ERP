    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-2">
          <Button onClick={() => router.push('/dashboard-backup/inventory')}>
            Inventory
          </Button>
          <Button onClick={() => router.push('/dashboard-backup/customers')}>
            Customers
          </Button>
          <Button onClick={() => router.push('/dashboard-backup/sales')}>
            Sales
          </Button>
          <Button onClick={() => router.push('/dashboard-backup/reports')}>
            Reports
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-4 rounded shadow">
          ...
          <div className="mt-4 text-right">
            <button className="text-blue-500 text-sm" onClick={() => router.push('/dashboard-backup/activity')}>View All Activity</button>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded shadow">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button onClick={() => router.push('/dashboard-backup/inventory/add')}>
              Add Inventory
            </Button>
            <Button onClick={() => router.push('/dashboard-backup/customers/new')}>
              Add Customer
            </Button>
            <Button onClick={() => router.push('/dashboard-backup/sales/new')}>
              Create Sale
            </Button>
            <Button onClick={() => router.push('/dashboard-backup/reports')}>
              Generate Report
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center p-2 bg-red-50 rounded">
              ...
              <button className="text-blue-500 text-sm" onClick={() => router.push('/dashboard-backup/inventory/restock')}>Restock</button>
            </div>
            <div className="flex justify-between items-center p-2 bg-yellow-50 rounded">
              <span>Pending verification: Blue Dream</span>
              <button className="text-blue-500 text-sm" onClick={() => router.push('/dashboard-backup/inventory/verify')}>Verify</button>
            </div>
          </div>
        </div>
      </div>
