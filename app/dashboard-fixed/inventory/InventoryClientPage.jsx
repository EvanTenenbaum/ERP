  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => router.push('/dashboard-fixed/inventory/add')}>Add New Item</Button>
      </div>
            ...
            {filteredItems.map(item => (
              <tr key={item.id}>
                ...
                <td className="py-2 px-4 border-b">
                  <Button size="sm" onClick={() => router.push(`/dashboard-fixed/inventory/${item.id}`)}>View</Button>
                  <Button size="sm" className="ml-2" onClick={() => router.push(`/dashboard-fixed/inventory/${item.id}/edit`)}>Edit</Button>
                </td>
              </tr>
            ))}
          </tbody>
