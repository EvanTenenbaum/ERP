...
export default function Alert({
  ...
  // Variant styles
  const variantStyles = {
    info: 'bg-blue-50 text-blue-800 dark:bg-blue-900 dark:text-blue-300 border-blue-200 dark:border-blue-800',
    success: 'bg-green-50 text-green-800 dark:bg-green-900 dark:text-green-300 border-green-200 dark:border-green-800',
    warning: 'bg-yellow-50 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300 border-yellow-200 dark:border-yellow-800',
    error: 'bg-red-50 text-red-800 dark:bg-red-900 dark:text-red-300 border-red-200 dark:border-red-800',
  };
  ...
  return (
    <div 
      className={`rounded-md border p-4 ${variantStyles[variant] || variantStyles.info} ${className}`}
      role="alert"
      {...props}
    >
      <div className="flex">
